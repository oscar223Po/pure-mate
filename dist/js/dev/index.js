...
const isQueenPiece = (el) => el && [...el.classList].some((cls) => cls.includes("queen"));
const SHOW = (el) => {
  if (!el) return;
...
document.addEventListener("pointerup", (e) => {
  ...
  const dropCell = document.elementFromPoint(e.clientX, e.clientY)?.closest("span");
  ...
  if (hoverQueen && !hoverQueen.classList.contains("disable") && !board.classList.contains("is-hover-lock")) {
